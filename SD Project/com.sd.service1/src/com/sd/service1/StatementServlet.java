...
public class StatementServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	request.setAttribute("colorMenu1",colorMenu1);
       	request.setAttribute("colorMenu2",colorMenu2);
       	request.setAttribute("colorMenu3",colorMenu3);
       	request.setAttribute("colorMenu4",colorMenu4);
